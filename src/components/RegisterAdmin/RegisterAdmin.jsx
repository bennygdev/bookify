...
import mosaicAdminRegister from '../../assets/images/mosaicadminregister.png';
...
function RegisterAdmin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://localhost/api/Authenticate/register-admin", {
                method: "POST",
                headers: {
  ...
  return (
    <>
        <div className={`${styles.adminRegister__container} container mt-5`}>
        <div className="row justify-content-center">
            <div className="col-md-12">
                <div className="card">
                    <div className="row">
                        <div className="col-md-6">
                            <img className="loginimage img-fluid" src={mosaicAdminRegister} alt="" />    
                        </div>
                        <div className="col-md-6 p-5">
                            ...
                            <form onSubmit={handleSubmit} id="registerForm" action="post">
                                <div className="form-group">
                                    <label className={`${styles.username} username mb-2`} htmlFor="username">Username</label>
                                    <input type="text" className="form-control mb-2" id="username" name="username"  placeholder="e.g. Mary, Mark" required />
                                </div>
                                <div className="form-group">
                                    <label className={`${styles.email} email mb-2`} htmlFor="email">Email</label>
                                ...
                                <p>Register as a member? <Link to="/register">Register</Link></p>
                                <button type="submit" className={styles.adminRegister__btn} id="register__btn">Register</button>
                            </form>
                        </div>
                    </div>
                </div>
